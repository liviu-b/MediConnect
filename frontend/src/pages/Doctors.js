            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center space-x-2 text-gray-600">
                  ...
                  <span>{t('doctors.consultation', { duration: doctor.consultation_duration })}</span>
                </div>
                {doctor.email && (
                  <div className="flex items-center space-x-2 text-gray-600">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center modal-backdrop" data-testid="doctor-modal">
          <div className="bg-white rounded-2xl p-6 w-full max-w-lg mx-4 animate-fadeIn max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t('doctors.userAccount')}</label>
                <select
                ...
                >
                  <option value="">{t('doctors.selectUser')}</option>
                  {users.map(u => (
                ...
                <p className="text-xs text-gray-500 mt-1">{t('doctors.userHelp')}</p>
              </div>
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                >
                  {saving ? t('common.loading') : editingDoctor ? t('doctors.updateDoctor') : t('doctors.addDoctor')}
                </button>
              </div>
            </form>
          </div>
